"""Lab Routes - Original developer/researcher interface.

This blueprint provides the original inference lab interface where users can:
- Input custom rules manually
- Test forward and backward chaining
- View FPG and RPG graphs
- Debug inference processes
"""
...
@lab_bp.get("/")
def index() -> str:
    """Lab homepage with manual rule input."""
    sample_payload = {
...
@lab_bp.post("/api/infer")
def api_infer():
    """Run inference (forward or backward) based on request."""
